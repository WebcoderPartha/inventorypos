        ...
        <div class="row">
            <div class="col-10 mx-auto">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" @submit.prevent="storeProduct">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-6">
                                        ...
                                        <span class="text-danger" v-if="errors ? errors.image : ''"><b><small>{{ errors.image[0] }}</small></b></span>
                                    </div>
                                    <div class="col-6">
                                        <img id="upload" alt="" width="80">
                                    </div>
                                </div>
                            </div>
    ...
    methods:{
        ...
        selectImage(event){
            ...
            if (file.size > 2097152){
                Notification.Error("<b>Upload image must be less than 2MB</b>")
            }else{
        ...
        storeProduct(){
            axios.post('/api/auth/product', this.form)
                .then(response => {
