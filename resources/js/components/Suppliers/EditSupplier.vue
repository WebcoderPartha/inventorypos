        ...
        <div class="row">
            <div class="col-10 mx-auto">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" @submit.prevent="updateSupplierById()">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-6">
                                        <img id="showPhoto" :src="imagePath(form.photo)" alt="" style="width: 60px; height: 100%">
                                    </div>
                                </div>
                            </div>
...
export default {
    ...
    methods:{
        getSupplierById(){
            axios.get(`/api/auth/supplier/${this.$route.params.id}`)
                .then(response => {
        ...
        SelectImage(event){
            ...
            if (file.size > 1048576){
                Notification.Error('<b>Upload image must be less then 1MB</b>')
            }else{
        ...
        updateSupplierById(){
            ...
            axios.put(`/api/auth/supplier/${id}`, this.form)
                .then(response => {
